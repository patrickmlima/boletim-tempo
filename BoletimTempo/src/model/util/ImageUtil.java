...
public class ImageUtil {
	 ...
	 * 
	 * @param im
	 *            the Image object to be resized
	 * @param w
	 *            an integer which represents the new width
	 * @param h
	 *            an integer which represents the new height
	...
	/**
	 * Resizes an image and returns as ImageIcon instance
	 * 
	 * @param w
	 *            the new width
	 * @param h
	 ...
	 * @return an ImageIcon obtained from the im object
	 */
